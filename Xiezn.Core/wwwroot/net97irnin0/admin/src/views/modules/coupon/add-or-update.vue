	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="券类型" prop="type">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="券类型" prop="type">
