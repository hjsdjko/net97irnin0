	...
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="鲜花分类" prop="xianhuafenlei">
					<el-select :disabled="ro.xianhuafenlei" v-model="ruleForm.xianhuafenlei" placeholder="请选择鲜花分类" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="鲜花分类" prop="xianhuafenlei">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="鲜花规格" prop="xianhuaguige">
					<el-input v-model="ruleForm.xianhuaguige" placeholder="鲜花规格" clearable  :readonly="ro.xianhuaguige"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="鲜花规格" prop="xianhuaguige">
					<el-input v-model="ruleForm.xianhuaguige" placeholder="鲜花规格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="鲜花产地" prop="xianhuachandi">
					<el-input v-model="ruleForm.xianhuachandi" placeholder="鲜花产地" clearable  :readonly="ro.xianhuachandi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="鲜花产地" prop="xianhuachandi">
					<el-input v-model="ruleForm.xianhuachandi" placeholder="鲜花产地" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="鲜花花语" prop="xianhuahuayu">
					<el-input v-model="ruleForm.xianhuahuayu" placeholder="鲜花花语" clearable  :readonly="ro.xianhuahuayu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="鲜花花语" prop="xianhuahuayu">
					<el-input v-model="ruleForm.xianhuahuayu" placeholder="鲜花花语" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="适用场景" prop="shiyongchangjing">
					<el-input v-model="ruleForm.shiyongchangjing" placeholder="适用场景" clearable  :readonly="ro.shiyongchangjing"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="适用场景" prop="shiyongchangjing">
					<el-input v-model="ruleForm.shiyongchangjing" placeholder="适用场景" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="送礼对象" prop="songliduixiang">
					<el-input v-model="ruleForm.songliduixiang" placeholder="送礼对象" clearable  :readonly="ro.songliduixiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="送礼对象" prop="songliduixiang">
					<el-input v-model="ruleForm.songliduixiang" placeholder="送礼对象" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="鲜花详情" prop="xianhuaxiangqing">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.xianhuaxiangqing" label="鲜花详情" prop="xianhuaxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.xianhuaxiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.xianhuaxiangqing = this.ruleForm.xianhuaxiangqing.replace(reg,'../../../net97irnin0/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
