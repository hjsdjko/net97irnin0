		...
		>
			<template v-show="logistics">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="折扣价格" prop="discountprice">
					<el-input-number v-model="ruleForm.discountprice" placeholder="折扣价格" :readonly="ro.discountprice"></el-input-number>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="折扣总价格" prop="discounttotal">
					<el-input-number v-model="ruleForm.discounttotal" placeholder="折扣总价格" :readonly="ro.discounttotal"></el-input-number>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="统一订单编号" prop="orderno">
					<el-input v-model="ruleForm.orderno" placeholder="统一订单编号" clearable  :readonly="ro.orderno"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="统一订单编号" prop="orderno">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.logistics = this.ruleForm.logistics.replace(reg,'../../../net97irnin0/upload');
        } else {
