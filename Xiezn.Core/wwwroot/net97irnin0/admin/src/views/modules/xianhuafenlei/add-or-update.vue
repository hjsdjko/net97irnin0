<template>
	<div class="addEdit-block" :style='{"padding":"30px","margin":"0"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="鲜花分类" prop="xianhuafenlei">
					<el-input v-model="ruleForm.xianhuafenlei" placeholder="鲜花分类" clearable  :readonly="ro.xianhuafenlei"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="鲜花分类" prop="xianhuafenlei">
					<el-input v-model="ruleForm.xianhuafenlei" placeholder="鲜花分类" readonly></el-input>
				</el-form-item>
