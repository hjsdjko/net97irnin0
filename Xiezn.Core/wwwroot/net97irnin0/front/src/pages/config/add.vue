...
<div :style='{"border":"2px solid #DF847F","width":"90%","padding":"20px 0","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="值" v-if="type!='cross' || (type=='cross' && !ro.value)" prop="value">
            <file-upload
            tip="点击上传值"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' class="upload" v-else label="值" prop="value">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"#fff"}' label="url" prop="url">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="url"
