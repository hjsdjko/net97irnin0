<template>
	...
	<div :style='{"width":"100%","padding":"0 10px"}'>
		<div :style='{"width":"80%","margin":"20px auto","height":"auto"}'>
			<div :style='{"margin":"10px 0","color":"#DF847F","textAlign":"center","background":"url(http://codegen.caihongy.cn/20231220/e54f6cd4929f4d00b2ead8e5a5991d16.png)","fontSize":"26px","lineHeight":"54px","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","fontWeight":"bold"}'>公告信息</div>
		</div>
