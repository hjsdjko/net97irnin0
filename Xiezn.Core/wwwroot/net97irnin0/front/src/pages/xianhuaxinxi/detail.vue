...
<div>
	<div :style='{"padding":"20px 20px 60px","margin":"10px auto","borderRadius":"0","background":"url(http://codegen.caihongy.cn/20231217/d400927926594c4db68c914d1fab2fc3.png)","width":"90%","backgroundSize":"100% 40%","backgroundPosition":"bottom center","backgroundRepeat":"no-repeat"}' class="breadcrumb-preview">
		<el-breadcrumb :separator="'>'" :style='{"fontSize":"16px","lineHeight":"1"}'>
			...
			<el-breadcrumb-item class="item2" v-for="(item, index) in breadcrumbItem" :key="index" to="/index/xianhuaxinxi"><a>{{item.name}}</a></el-breadcrumb-item>
	...
	<div class="detail-preview" :style='{"padding":"0 5%","margin":"10px auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex","width":"100%","position":"relative"}'>
		<div class="attr" :style='{"width":"55%","padding":"0 20px","position":"relative","background":"#fff","display":"flex","order":"2"}'>
			...
			<div class="info" :style='{"padding":"0 10px","margin":"0 0 0 10px","background":"#fff","flex":"1"}'>
				...
				<div class="item" :style='{"padding":"10px 0","margin":"0 0 10px 0","alignItems":"center","background":"#fff","justifyContent":"space-between","display":"flex"}'>
					...
					<el-button :style='{"border":"1px solid #DF847F","cursor":"pointer","padding":"0 30px","margin":"0 10px 10px 0","outline":"none","color":"#DF847F","borderRadius":"0","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"15px","height":"40px"}' type="warning" size="small" @click="couponClick">优惠券</el-button>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}' v-if="detail.price">
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>价格</div>
					<div style="font-weight: bold;" :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'><span :style='{"fontSize":"12px"}'>￥</span>{{detail.price}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}' v-if="detail.price">
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>会员价</div>
					<div style="font-weight: bold;" :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'><span :style='{"fontSize":"12px"}'>￥</span>{{detail.vipprice}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}' v-if="detail.jf">
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>积分</div>
					<div style="color: red;font-weight: bold;" :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'>{{detail.jf}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>单限</div>
					<div :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'>{{detail.onelimittimes}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>库存</div>
					<div :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'>{{detail.alllimittimes}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>鲜花分类</div>
					<div  :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'>{{detail.xianhuafenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>鲜花规格</div>
					<div  :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'>{{detail.xianhuaguige}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>鲜花产地</div>
					<div  :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'>{{detail.xianhuachandi}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>鲜花花语</div>
					<div  :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'>{{detail.xianhuahuayu}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>适用场景</div>
					<div  :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'>{{detail.shiyongchangjing}}</div>
				</div>
				<div class="item" :style='{"padding":"10px","margin":"0","background":"#f5f5f5","justifyContent":"spaceBetween","display":"flex"}'>
					<div class="lable" :style='{"padding":"0 10px","color":"#333","textAlign":"left","width":"auto","fontSize":"15px","lineHeight":"40px","height":"40px"}'>送礼对象</div>
					<div  :style='{"padding":"8px 10px 0","color":"#888","textAlign":"left","flex":"1","fontSize":"15px","lineHeight":"24px","height":"auto"}'>{{detail.songliduixiang}}</div>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-input-number :style='{"width":"480px","margin":"0 10px 10px 0","lineHeight":"38px","position":"relative","display":"inline-block"}' v-if="detail.alllimittimes" :min=1 v-model="buynumber"></el-input-number>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 30px","margin":"0 10px 10px 0","outline":"none","color":"#fff","borderRadius":"0","background":"#DF847F","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="detail.alllimittimes" type="warning" size="small" @click="addCart">添加到购物车</el-button>
					<el-button :style='{"border":"1px solid #DF847F","cursor":"pointer","padding":"0 30px","margin":"0 10px 10px 0","outline":"none","color":"#DF847F","borderRadius":"0","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"15px","height":"40px"}' v-if="detail.alllimittimes" type="warning" size="small" @click="buyNow">立即购买</el-button>

					<el-button :style='{"border":"1px solid #DF847F","cursor":"pointer","padding":"0 30px","margin":"0 10px 10px 0","outline":"none","color":"#DF847F","borderRadius":"0","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"15px","height":"40px"}' v-if="detail.alllimittimes" type="warning" size="small" @click="jfTap">积分兑换</el-button>
				</div>
				<div class="btn" :style='{"padding":"10px 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"1px solid #DF847F","cursor":"pointer","padding":"0 30px","margin":"0 10px 10px 0","outline":"none","color":"#DF847F","borderRadius":"0","background":"#fff","width":"auto","lineHeight":"40px","fontSize":"15px","height":"40px"}' v-if="btnAuth('xianhuaxinxi','修改')" @click="editClick">修改</el-button>
					<el-button :style='{"border":"1px solid #DF847F","cursor":"pointer","padding":"0 30px","margin":"0 10px 10px 0","outline":"none","color":"#DF847F","borderRadius":"0","background":"none","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="btnAuth('xianhuaxinxi','删除')" @click="delClick">删除</el-button>
			...
			<!-- 热门信息 -->
			<div class="hot" :style='{"border":"2px solid #DF847F","width":"200px","boxShadow":"none","background":"#fff","height":"auto","order":"5"}'>
			  <div :style='{"border":"1px solid #DF847F","margin":"0 auto 10px","color":"#DF847F","textAlign":"center","background":"none","borderWidth":"0 0 2px","width":"calc(100% - 40px)","lineHeight":"54px","fontSize":"18px","fontWeight":"bold"}'>热门信息</div>
			  <div :style='{"width":"100%","padding":"0 0 5px 0","background":"#fff","height":"auto"}'>
			    <div v-for="item in hotList" :key="item.id" :style='{"width":"100%","padding":"5px 25px 0","background":"#fff","height":"auto"}' @click="toDetail(item)">
			      <img :style='{"width":"100%","objectFit":"cover","borderRadius":"50px","display":"block","height":"150px"}' v-if="item.xianhuatupian && item.xianhuatupian.substr(0,4)=='http'" :src="item.xianhuatupian" alt="">
			      <img :style='{"width":"100%","objectFit":"cover","borderRadius":"50px","display":"block","height":"150px"}' v-else :src="baseUrl + (item.xianhuatupian?item.xianhuatupian.split(',')[0]:'')" alt="">
			      <div :style='{"padding":"4px 5px 0","lineHeight":"1.5","fontSize":"16px","color":"#000","textAlign":"center","fontWeight":"bold"}'>{{item.xianhuamingcheng}}</div>
			      <!-- <div :style='{"padding":"0 5px","lineHeight":"32px","fontSize":"14px","color":"#909090","textAlign":"center"}'>2022-02-02</div> -->
			    </div>
			  </div>
			</div>
		...
		<el-tabs class="detail" :style='{"border":"0","boxShadow":"none","padding":"0 20px","background":"#FFF","flex":"1","width":"100%","order":"6"}' v-model="activeName" type="border-card">
			<el-tab-pane label="鲜花详情" name="first">
				<div v-html="detail.xianhuaxiangqing"></div>
			</el-tab-pane>
  ...
  export default {
    ...
    methods: {
        ...
        init() {
          ...
          this.$http.get(this.tablename + '/detail/'  + this.id, {}).then(res => {
            if (res.data.code == 0) {
              ...
              this.title = this.detail.xianhuamingcheng;
              this.detailBanner = this.detail.xianhuatupian ? this.detail.xianhuatupian.split(",") : [];
              this.$forceUpdate();
        ...
        toDetail(item) {
          ...
          this.$router.push({path: '/index/xianhuaxinxiDetail', query: params});
          this.init();
        ...
        getHotList() {
          let autoSortUrl = "";
          autoSortUrl = "xianhuaxinxi/autoSort";
          if(localStorage.getItem('frontToken')) {
              autoSortUrl = "xianhuaxinxi/autoSort2";
          }
      ...
      storeup(type) {
        if (type == 1 && !this.isStoreup) {
          ...
          this.$http.post('storeup/add', this.storeupParams).then(res => {
            if (res.data.code == 0) {
			  ...
			  this.$http.post('xianhuaxinxi/update', this.detail).then(res => {});
              this.$message({
                type: 'success',
                message: '收藏成功!',
                duration: 1500,
        ...
        if (type == -1 && this.isStoreup) {
          this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'xianhuaxinxi', userid: localStorage.getItem('frontUserid')}}).then(res => {
      ...
      getDiscussList(page) {
        this.$http.get('discussxianhuaxinxi/list', {params: {page, limit: this.pageSize, refid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
	  ...
	  discussDel(id){
		  this.$confirm('是否删除此评论？')
		    .then(_ => {
		      this.$http.post('discussxianhuaxinxi/delete',[id]).then(res=>{
            ...
            this.$http.get('orders/list', {params: {page: 1, limit: 1, status: '已完成', goodid: this.detail.id, userid: localStorage.getItem('frontUserid')}}).then(res => {
                if (res.data.code == 0 && res.data.data.list.length == 0) {
                  ...
                  return false
                    ...
                    this.$http.post('discussxianhuaxinxi/add', this.form).then(res => {
						if (res.data.code == 0) {
      ...
      getCartList() {
        this.$http.get('cart/list', {params: {userid: localStorage.getItem('frontUserid'), tablename: 'xianhuaxinxi', goodid: this.detail.id}}).then(res => {
          if (res.data.code == 0) {
      ...
      addCart() {
		...
		// 修改
		editClick(){
			this.$router.push(`/index/xianhuaxinxiAdd?type=edit&&id=${this.detail.id}`);
		},
		// 删除
		async delClick(){
			await this.$confirm('是否删除此鲜花信息？')
			  .then(_ => {
			    this.$http.post('xianhuaxinxi/delete', [this.detail.id]).then(async res => {
					if (res.data.code == 0) {
