...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"border":"1px solid #C7C7C7","padding":"0","margin":"20px auto 0","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"auto","justifyContent":"center","height":"auto"}'>
      <el-form-item :style='{"margin":"0 10px","display":"inline-block"}'>
	    <div class="lable" v-if="false" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>生效时间：</div>
        <el-date-picker 
          v-model="timeRange"
          type="datetimerange"
          range-separator="至"
		  :style='{"border":"0","padding":"3px 10px","outline":"none","borderRadius":"0","background":"#fff","borderWidth":"0","width":"auto","justifyContent":"center"}'
      ...
      <el-form-item :style='{"margin":"0 10px","display":"inline-block"}'>
	    <div class="lable" v-if="false" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>过期时间：</div>
        <el-date-picker 
          v-model="timeRange"
          type="datetimerange"
          range-separator="至"
	  ...
	  <el-button v-if="btnAuth('coupon','新增')" :style='{"cursor":"pointer","border":"0","padding":"0px 15px","margin":"0","outline":"none","color":"#fff","borderRadius":"0","background":"#80BBCA","width":"auto","fontSize":"14px","lineHeight":"42px","height":"42px"}' type="primary" @click="add('/index/couponAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
