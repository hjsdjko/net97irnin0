...
{
    public class CouponService : BaseService<CouponDbModel>
    {
        ...
        public PageModel<CouponDbModel> GetPageList(int page, int limit, string sort, string order, List<IConditionalModel> conModels)
        {
            ...
            List<CouponDbModel> ts = Db.Queryable<CouponDbModel>().Where(conModels).OrderBy(mysort).ToPageList(page, limit, ref totalNumber, ref totalPage);


            PageModel<CouponDbModel> t = new PageModel<CouponDbModel>()
            {
                Code = ResponseCodeEnum.Success,
                Data = new Page<CouponDbModel>()
                {
                    Total = totalNumber,
                    PageSize = limit,
                    TotalPage = totalPage,
